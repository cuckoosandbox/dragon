...
from lib.dragon.common.constants import CUCKOO_ROOT, CUCKOO_VERSION
from lib.dragon.common.exceptions import CuckooStartupError
from lib.dragon.common.exceptions import CuckooOperationalError
from lib.dragon.common.exceptions import CuckooDependencyError
from lib.dragon.common.utils import create_folders
from lib.dragon.common.config import Config
from lib.dragon.common.colors import *
from lib.dragon.core.plugins import import_plugin, import_package, list_plugins
...
def check_working_directory():
    ...
    cwd = os.path.join(os.getcwd(), "dragon.py")
